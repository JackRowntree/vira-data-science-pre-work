...
app.layout = html.Div(
    ...
    """
        ...
        dash_table.DataTable(
            df_baseline_null_stats.to_dict("records"),
            [{"name": i, "id": i} for i in df_baseline_null_stats.columns],
            page_action="none",
    ...
    """
        ...
        dash_table.DataTable(
            df_visit1_null_stats.to_dict("records"),
            [{"name": i, "id": i} for i in df_visit1_null_stats.columns],
            page_action="none",
            style_table={"height": "300px", "overflowY": "auto"},
        ),
        html.H2(
    ...
    """
        ...
        dash_table.DataTable(
            df_visit2_null_stats.to_dict("records"),
            [{"name": i, "id": i} for i in df_visit2_null_stats.columns],
            page_action="none",
            style_table={"height": "300px", "overflowY": "auto"},
        ),
    ]
